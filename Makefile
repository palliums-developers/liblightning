...
ifeq ($(STATIC),1)
LDLIBS = -L/usr/local/lib -Wl,-dn -levent -lpthread -lcrypto -lgmp -lsqlite3 -lz -Wl,-dy -lm -lpthread -ldl $(COVFLAGS)
else
LDLIBS = -L/usr/local/lib -levent -lpthread -lcrypto -lm -lgmp -lsqlite3 -lz $(COVFLAGS)
endif
